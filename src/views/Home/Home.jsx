...
export const Home = () => {
    ...
    return (
        <>
            {/* banner with image */}
            <div className='lg:flex mx-auto py-20 lg:px-[120px]' style={{ backgroundImage: `url("${img}")`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}>
            ...
            <div>
                <div className='text-center px-4'>
                    ...
                    <p className='text-wrap mx-auto xl:w-[564px]'>Finis les longues minutes d’attente, les tarifs élévés, et les prises de tête avec le chauffeur ! Simplifiez vous la vie avec Treiize Taxi.</p>
                </div>
                ...
                <div className="grid md:grid-cols-1 lg:grid-cols-2 md:items-center my-4">
                    <div className='bg-[#3C3C3C] h-full py-8 px-4 lg:px-10 flex items-center'>
                        <div className='lg:px-20'>
                            <h1 className='leading-10 text-white text-[30px] lg:text-[40px] font-bold'>Devenez conducteur sur Treiize Taxi</h1>
                            <p className='my-3 text-[18px] font-medium text-white'>Rejoingez Treiize Taxi en tant que conducteur, définissez votre planning et percevez des revenus en conduisant !</p>
