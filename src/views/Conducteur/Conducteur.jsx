        ...
        <>
            <div className='flex items-center bg-slate-900 h-96 xl:h-[510px]' style={{ backgroundImage: `url("${banner}")`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}>
                <div className='lg:flex mx-auto xl:max-w-7xl'>
                    <div className="my-4">
                        <div className='px-4 md:px-24 lg:px-40 lg:w-10/12'>
            ...
            <div>
                <div className='mt-8 text-center px-4'>
                    <h1 className='text-[#000000] text-[28px] lg:text-[40px] font-bold'>Gagnez en temps et en argent</h1>
                    <p className='text-wrap mx-auto xl:w-[564px]'>Passez au niveau supérieur avec Treiize Taxi et ne monétisez chaque minutes de votre temps libre sans gaspiller votre carburant.</p>
                </div>
                <div className='my-8'>
                    <div className='px-4 grid md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 max-sm:gap-6 sm:gap-6 md:gap-8 lg:px-38 xl:px-48'>
                        {
                            steps.map((item) => (
                ...
                <div className='text-center'>
                    <button className='border-none text-[14px] text-white btn btn-sm rounded-full font-semibold w-[313px] h-[37px] bg-[#F15625] hover:bg-[#F15625]'>Devenir conducteur sur Treiize Taxi</button>
                </div>

            </div>

            <div className='mt-32 flex items-start justify-c xl:px-24 mx-auto max-w-7xl'>
                <div className="px-4 grid md:grid-cols-2 md:items-center my-4">
                    <div className=''>
                        <img src={img1} alt="" className='object-cover' />
                    </div>
                    <div className=''>
                        <h1 className='leading-10 text-[#000000] text-[26px] lg:text-[35px] font-bold'>Comment fonction l’appli
                            Treiize Taxi Driver</h1>
            ...
            <div className='text-center max-sm:px-4 mt-20'>
                <h1 className='text-[#000000] max-sm:text-[22px] sm:text-[28px] md:text-[30px] lg:text-[35px] font-bold'>Foire aux questions des chauffeurs</h1>
            </div>
